...
JNIEXPORT extern "C" jobject JNICALL
...
Java_com_pvporbit_freetype_Utils_fillBuffer(JNIEnv *env, jclass obj, jbyteArray bytes,
    ...
    auto *dst = (unsigned char *) (buffer ? env->GetDirectBufferAddress(buffer) : 0);
...
JNIEXPORT extern "C" jboolean JNICALL
...
JNIEXPORT extern "C" jboolean JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Load_1Math_1Table
...
JNIEXPORT extern "C" jint JNICALL
...
JNIEXPORT extern "C" jstring JNICALL
...
/*
JNIEXPORT extern "C" jlongArray JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1Kerning(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
...
JNIEXPORT extern "C" jlong JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1KerningX(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
	if (FT_Get_Kerning((FT_Face)face, left, right, mode, &vector))
		return 0;
	return vector.x;
}
JNIEXPORT extern "C" jlong JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1KerningY(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
	if (FT_Get_Kerning((FT_Face)face, left, right, mode, &vector))
		return 0;
	return vector.y;
...
Java_com_pvporbit_freetype_FreeType_FT_1Request_1Size(JNIEnv *env, jclass obj, jlong face,
    ...
    req.height = env->GetIntField(sizeRequest, env->GetFieldID(sizeRequestClass, "height", "I"));
    req.width = env->GetIntField(sizeRequest, env->GetFieldID(sizeRequestClass, "width", "I"));
...
JNIEXPORT extern "C" jintArray JNICALL
