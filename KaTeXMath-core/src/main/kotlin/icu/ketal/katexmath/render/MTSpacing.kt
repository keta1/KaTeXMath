...
fun getInterElementSpaceArrayIndexForType(type: MTMathAtomType, row: Boolean): Int {
    ...
    // A placeholder is treated as ordinary
        MTMathAtomType.KMTMathAtomColor, MTMathAtomType.KMTMathAtomTextColor, MTMathAtomType.KMTMathAtomOrdinary, MTMathAtomType.KMTMathAtomPlaceholder,
        MTMathAtomType.KMTMathAtomOverline, MTMathAtomType.KMTMathAtomUnderline, MTMathAtomType.KMTMathAtomBoxed -> return 0
