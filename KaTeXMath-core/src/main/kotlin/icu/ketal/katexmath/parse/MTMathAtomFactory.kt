...
open class MTMathAtomFactory {
  ...
  private fun placeholderList(): MTMathList = MTMathList().apply {
    addAtom(placeholder())
  }

  @Suppress("unused")
  private fun placeholderFraction(): MTFraction = MTFraction().apply {
  ...
  fun fontNameForStyle(fontStyle: MTFontStyle) = when (fontStyle) {
    MTFontStyle.KMTFontStyleDefault -> "mathnormal"
    MTFontStyle.KMTFontStyleRoman -> "mathrm"
    MTFontStyle.KMTFontStyleBold -> "mathbf"
    MTFontStyle.KMTFontStyleFraktur -> "mathfrak"
    MTFontStyle.KMTFontStyleCaligraphic -> "mathcal"
    MTFontStyle.KMTFontStyleItalic -> "mathit"
    MTFontStyle.KMTFontStyleSansSerif -> "mathsf"
    MTFontStyle.KMTFontStyleBlackboard -> "mathbb"
    MTFontStyle.KMTFontStyleTypewriter -> "mathtt"
    MTFontStyle.KMTFontStyleBoldItalic -> "bm"
  }
  ...
  fun tableWithEnvironment(
    ...
    table.cells = cells
    val matrixEnvs: HashMap<String, Array<String>> = hashMapOf(
      "matrix" to arrayOf(""),
      "pmatrix" to arrayOf("(", ")"),
      "bmatrix" to arrayOf("[", "]"),
      "Bmatrix" to arrayOf("{", "}"),
  ...
  private val supportedLatexSymbols: HashMap<String, MTMathAtom> = hashMapOf(
    ...
    "nrightarrow" to MTMathAtom(MTMathAtomType.KMTMathAtomRelation, "\u219B"),
    ...
    "iint" to operatorWithName("\u222C", false),
    "iiint" to operatorWithName("\u222D", false),
    "iiiint" to operatorWithName("\u2A0C", false),
    "oint" to operatorWithName("\u222E", false),
    "oiint" to operatorWithName("\u222F", false),
    "oiiint" to operatorWithName("\u2230", false),
  ...
  // Reverse mapping of supportedLatexSymbols with preference for the shortest latex command if two commands have the same nucleus mapping
